...
Backend API behavior is covered by `bookmarks-api.test.ts`, which runs the Bun/Elysia smoke suites for create, list/get, and update behavior. Feature-local repository, domain, and utility tests live next to the modules they verify.
