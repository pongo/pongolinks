...
## Convert existing request handlers from scattered logs to evlog wide events
...
Docs: [https://www.evlog.dev/learn/wide-events](https://www.evlog.dev/learn/wide-events)
Best practices: [https://www.evlog.dev/reference/best-practices](https://www.evlog.dev/reference/best-practices)
